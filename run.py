...
from model.STLBGN import STLBGN as Network
from model.BSTrainer import Trainer
...
args.add_argument('--model', default='STLBGN', type=str)
args.add_argument('--cuda', default=True, type=bool)
args1 = args.parse_args()

#get configuration
config_file = './config_file/{}.conf'.format(args1.dataset)
...
args.add_argument('--hidden_units', default=config['model']['hidden_units'], type=int)
args.add_argument('--fusion', default=config['model']['fusion'], type=int)
args.add_argument('--gcn_k', default=config['model']['gcn_k'], type=int)
